...
<html>
    ...
    <body>
        <div id="page-wrapper">
                ...
                <nav class="nav-bar">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li><a class="fa fa-angle-right"></a></li>
                            <li><a href="bibliotheek-legenda.php">Nieuw legenda image</a></li>
                        </ul>
                    </div>
                    ...
                    <ul class="menu-sidebar">
                        ...
                        <li class="active open">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="legenda.html">Legenda image</a></li>
                            </ul>
                        </li>
                        <li>
            ...
            <section id="content">
                <div class="container">
                    <a href="legenda.html" class="btn outlined btn-small btn-dark-blue rounded uppercase">TERUG nAAR Legenda image</a>
