...
<html>
    ...
    <body>
        <div id="page-wrapper">
                ...
                <nav class="nav-bar">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li><a href="users#">Project-1</a></li>
                        </ul>
                    </div>
                ...
                <nav class="nav-sidebar">
                    <ul class="menu-sidebar">
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="bibliotheek-styling.php">Styling</a></li>
                        ...
                        <li class="active open">
                            ...
                            <ul>
                                <li class="active"><a href="project-algemeen.php">Algemeen</a></li>
            ...
            <section id="content">
                <div class="container">
                    <label class="slide-checkbox-big checkbox-green">ZICHTBAARHEID<input type="checkbox" class="custom-checkbox slide-checkbox checkbox-green" checked></label>
	                ...
	                <form id="form" class="form-horizontal form-validate">
						...
						<div class="block">
							...
							<div class="form-group">
							    <label for="inputName" class="control-label">Locatie:</label>
							    <div class="input-fields">
							    	<input type="text" class="form-control required name" id="inputName" name="inputName"  placeholder="Locatie">
							    </div>
							</div>
							<div class="form-group">
